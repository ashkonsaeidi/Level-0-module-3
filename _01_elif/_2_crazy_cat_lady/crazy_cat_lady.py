...
if __name__ == '__main__':
    ...
    cat = simpledialog.askstring(title=None, prompt="How many cats do you have")
    #      4) If they have 3 or more cats, tell them they are a crazy cat lady
    if cat >= 3:
        messagebox.showinfo(title=None, message="Your a crazy cat lady")
    #      5) If they have less than 3 cats AND more than 0 cats, call the
    #         play_video function below to show them a cat video
    if cat > 0 or cat < 3:
        play_video('https://www.youtube.com/watch?v=68OyRuuxjN0')
